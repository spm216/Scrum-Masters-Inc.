 ...
 * @author Shane
 */
public class NewSaleLoop extends javax.swing.JFrame {

    static Store store;
    /**
     * Creates new form NewSale
     */
    public NewSaleLoop(Store store) {
        initComponents();
        this.store = store;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewSaleLoop.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewSaleLoop(store).setVisible(true);
            }
        });
    }
